...
export const FormFeatured: FC<Props> = ({ featured, category }) => {
  ...
  const onSubmit = async (form: FormData) => {
    ...
    if (router.query.featured === 'new') {
      Swal.fire({
        position: 'center',
        icon: 'success',
        title: 'Destacado Creado',
        showConfirmButton: false,
        timer: 1500
      })
      await axios.put(`${process.env.APIS_URL}/api/site/addfeatured/${process.env.API_SITE}`, dat)
      ...
      await axios.put(`${process.env.APIS_URL}/api/site/updatefeatured/${process.env.API_SITE}`, da)
      router.replace(`/admin/sites/${router.query.category}`)
    }
                ...
                <div className="px-4 py-5 bg-white space-y-6 sm:p-6">
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-3 lg:gap-6">
                    ...
                    <div className="col-span-1">
                      <label className="block text-sm font-medium text-gray-700 mb-2">Imagen de Destacado</label>
